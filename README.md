...
<p align="center">
  ...
  <img src="https://img.shields.io/badge/version-1.0.0-8B9BB0?style=flat-square" alt="v1.0.0" />
</p>

<p align="center">
  <a href="https://github.com/MRJOHN5ON/RideStats/releases/latest"><strong>Download APK</strong></a>
</p>
...
RideStats lets you **log roller coaster rides from your phone** — record a session, see your peak G and ride timeline, save your history, and share a ride card when you want to.

Everything stays **on your device**. No account, no cloud, no tracking.

Version 1 includes the **Six Flags Magic Mountain** coaster catalog. RideStats is an **independent fan app** and is not affiliated with any theme park.
...
Start a session, lock your phone, and ride. RideStats keeps logging G-forces in the background.
...
Demo build — no warranty. G-force readings are phone estimates, not official park data. Use at your own risk.

---

## Ride report

After a ride you get peak G, stats, a force timeline, optional rating and notes, and a comparison against catalog reference estimates.
...
Full Flutter app: recording, local storage, reports, history, share cards. Source is private; this page and the APK are the public showcase.
